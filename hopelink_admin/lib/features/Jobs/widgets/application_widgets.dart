                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [st.color.withOpacity(0.08), jSurf2],
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    snap.email,
                                    style: jMonoSm().copyWith(color: jSub),
                                  ),
                      ...
                      if (a.skills.isNotEmpty) ...[
                        ...
                        Wrap(
                          ...
                          runSpacing: 6,
                          children: a.skills
                              .map((s) => SkillChip(label: s, color: jTeal))
                              .toList(),
                        ),
                        const SizedBox(height: 14),
                      ],
...
class _ActionButtons extends StatelessWidget {
  ...
  const _ActionButtons({required this.application, required this.ctrl});
      ...
      return ClipRRect(
        ...
        child: Image.network(
          ...
          errorBuilder: (_, __, ___) =>
              _Initials(snapshot: snapshot, size: size),
        ),
      );
    }
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(text, style: jH3().copyWith(fontSize: 11, color: jSub)),
        ],
      ),
    );
  }
