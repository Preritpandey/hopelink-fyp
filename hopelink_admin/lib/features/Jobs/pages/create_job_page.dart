                      ...
                      children: [
                        ...
                        _FormSection(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(child: _CategoryDropdown(ctrl: ctrl)),
                                const SizedBox(width: 14),
                                Expanded(child: _JobTypeSelector(ctrl: ctrl)),
                              ],
                            ),
                          ],
                        ),
                        ...
                        _FormSection(
                          ...
                          children: [
                            ...
                            LocationMapPicker(
                              ...
                              title: 'Job Map Location',
                              accentColor: jTeal,
                              markerColor: jRose,
                              surfaceColor: jSurf3,
                              borderColor: jBorder2,
                              textColor: jText,
                              mutedTextColor: jSub,
                            ),
                          ],
                        ...
                        _FormSection(
                          ...
                          children: [
                            ...
                            // Suggestions
                            Text('Suggestions:', style: jMonoSm()),
                            ...
                            Obx(
                              () => Wrap(
                                ...
                                children: kJobSkillSuggestions
                                    .where(
                                      (s) => !ctrl.selectedSkills.contains(s),
                                    )
                                    .take(8)
                                    .map(
                                      (s) => _SuggestionChip(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Fill in the details to recruit volunteers',
                style: jMonoSm(),
              ),
            ],
          ),
      ...
      children: [
        Row(
          children: [
            ...
            const Text(' *', style: TextStyle(color: jRose, fontSize: 11)),
          ],
        ),
        const SizedBox(height: 6),
        Obx(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Volunteers receive a certificate upon completion.',
                  style: jMonoSm(),
                ),
              ],
            ),
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.add_rounded, size: 10, color: _h ? jGreen : jMuted),
...
class _TipsPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const tips = [
      (
        'Be specific',
        'Clear job titles and descriptions attract better candidates.',
      ),
      (
        'Set realistic quotas',
        'Only post as many positions as you can effectively manage.',
      ),
      ('List key skills', 'Specific skills help filter the right volunteers.'),
      (
        'Choose the right type',
        'Remote roles expand your reach, onsite builds community.',
      ),
      (
        'Offer recognition',
        'Certificates and credit hours boost volunteer motivation.',
      ),
    ];
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(t.$2, style: jMonoSm().copyWith(height: 1.5)),
                  ),
                ],
              ),
            ),
