        ...
        children: [
            ...
            () => Row(
              children: [
                ...
                CIconBtn(
                  ...
                  tooltip: 'List view',
                  onTap: () {
                    if (ctrl.viewMode.value != CampaignViewMode.list)
                      ctrl.toggleView();
                  },
          ...
          Obx(() {
            ...
            return GradBtn(
              ...
              ghost: true,
              onTap: selected == null ? null : () => ctrl.openDetail(selected),
            );
          }),
        ],
      ),
        ...
        children: [
          ...
          Obx(() {
            ...
            return Container(
              ...
              child: Text('$n result${n != 1 ? 's' : ''}', style: mono()),
            );
          }),
        ],
      ),
        ...
        child: Obx(
          () => DropdownButtonHideUnderline(
            child: DropdownButton<CampaignSortOption>(
              ...
              onChanged: (v) {
                if (v != null) widget.ctrl.setSort(v);
              },
              items: CampaignSortOption.values
                  .map(
                    (s) => DropdownMenuItem(
                      value: s,
                      child: Text(
...
class _Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      if (items.isEmpty) {
        final hasFilter =
            ctrl.activeFilter.value != CampaignStatusFilter.all ||
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(subtitle, style: bodySm(), textAlign: TextAlign.center),
