...
TextStyle rBody() =>
    GoogleFonts.nunitoSans(fontSize: 13, color: rText, height: 1.5);

TextStyle rBodySm() =>
    GoogleFonts.nunitoSans(fontSize: 12, color: rSub, height: 1.5);

TextStyle rMono() =>
    GoogleFonts.sourceCodePro(fontSize: 11, color: rSub, letterSpacing: 0.2);

TextStyle rMonoSm() =>
    GoogleFonts.sourceCodePro(fontSize: 10, color: rMuted, letterSpacing: 0.2);
